...
public class ThreadPoolApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			pool.shutdown(); // Previously submitted tasks are executed
	...
	private static void error() {
		System.out.println("ThreadPoolApp must be run with two postitive valued " + " integer arguments. The first detailing the number of jobs " + " the second the number of processing threads in the pool");
